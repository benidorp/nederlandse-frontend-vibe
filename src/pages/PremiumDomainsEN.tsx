                ...
                >
                  <CardHeader className="pb-2 sm:pb-3 p-3 sm:p-4 md:p-6">
                    <div className="mt-1 mb-2 flex justify-center">
                      <img src="/images/premium-domains-logo-en.png" alt={`Buy ${domain.name} - Premium Expired Domain with High MOZ Authority & SEO Value for Any Website`} className="w-20 h-auto object-contain" />
                    </div>
