...
const premiumDomains = [
  ...
  {
    name: "digopack.eu",
    description: "EU domain with backlinks from Campaign Archive, NU.nl, ORF.at and British Library.",
    mozScore: 22,
    pageAuthority: 22,
    linkingDomains: 54,
    inboundLinks: "91+",
    ...
    price: "€125",
    backlinks: "91+",
    topBacklinks: ["campaign-archive.com (DA 84)", "nu.nl (DA 91)", "orf.at (DA 86)", "bl.uk (DA 85)", "tudelft.nl (DA 82)"],
    stripePaymentLink: "https://buy.stripe.com/cNi3cv81xg18g5nf989Zm06"
  },
  {
    name: "flamenco-online.eu",
    description: "Cultural/music domain with backlinks from Wikipedia (EN, ES, FR, ZH, JA) and Creative Commons.",
    mozScore: 22,
    pageAuthority: 26,
    linkingDomains: 155,
    inboundLinks: "4.9K+",
