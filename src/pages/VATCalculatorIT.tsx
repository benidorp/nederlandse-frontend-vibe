...
const VATCalculatorIT = () => {
  ...
  return (
    <>
      <Helmet>
        <html lang="it" />
        <title>Calcolatore IVA Mondiale per Imprenditori | Calcolare IVA Internazionale</title>
        <meta name="description" content="Calcola facilmente l'IVA per qualsiasi paese del mondo. Calcolatore IVA professionale per imprenditori con aliquote attuali, calcoli IVA inclusa/esclusa e risultati chiari." />
        <meta name="viewport" content="width=device-width, initial-scale=1.0" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.iaee.eu/calcolatore-iva-mondiale" />
      ...
      <VATLanguageSwitcher currentLanguage="it" />
            ...
            <div className="container relative">
              <div className="max-w-4xl mx-auto text-center">
                <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 rounded-full bg-gradient-to-r from-primary/20 to-secondary/20 border border-primary/30 backdrop-blur-sm shadow-lg">
                  ...
                  <span className="text-sm font-semibold bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary">Mondiale • 60+ Paesi</span>
                </div>
                ...
                <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight bg-clip-text text-transparent bg-gradient-to-r from-primary via-secondary to-accent">
                  Calcolatore IVA Mondiale
                </h1>
                
                <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed">
                  Calcola facilmente e con precisione l'IVA (Imposta sul Valore Aggiunto) per qualsiasi paese del mondo. 
                  Calcolatore IVA professionale con aliquote attuali per imprenditori internazionali, freelance e aziende.
                </p>

                <div className="flex flex-wrap gap-6 justify-center text-sm mb-8">
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="w-5 h-5 text-primary" />
                    <span className="text-muted-foreground">60+ Paesi</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="w-5 h-5 text-primary" />
                    <span className="text-muted-foreground">Aliquote 2025</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="w-5 h-5 text-primary" />
                    <span className="text-muted-foreground">Risultato Immediato</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="w-5 h-5 text-primary" />
            ...
            <div className="container">
              <div className="max-w-5xl mx-auto">
                <div className="text-center mb-12">
                  <h2 className="text-3xl md:text-4xl font-bold mb-4">Come Funziona il Calcolatore IVA?</h2>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <Card className="relative overflow-hidden border-2 hover:border-primary/50 transition-all group hover:shadow-colorful duration-300">
                    <CardHeader>
                      ...
                      <CardTitle className="text-xl font-bold">1. Scegli il paese</CardTitle>
                    </CardHeader>
                    <CardContent>
                  ...
                  <Card className="relative overflow-hidden border-2 hover:border-secondary/50 transition-all group hover:shadow-colorful duration-300">
                    <CardHeader>
                      ...
                      <CardTitle className="text-xl font-bold">2. Scegli l'aliquota</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-muted-foreground leading-relaxed">
                        Seleziona l'aliquota ordinaria o ridotta. Ogni paese ha le proprie percentuali IVA.
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="relative overflow-hidden border-2 hover:border-accent/50 transition-all group hover:shadow-colorful duration-300">
                    <CardHeader>
                      ...
                      <CardTitle className="text-xl font-bold">3. Inserisci l'importo</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-muted-foreground leading-relaxed">
                  ...
                  <Card className="relative overflow-hidden border-2 hover:border-info/50 transition-all group hover:shadow-colorful duration-300">
                    <CardHeader>
                      ...
                      <CardTitle className="text-xl font-bold">4. Vedi il risultato</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-muted-foreground leading-relaxed">
                        Il calcolatore mostra immediatamente tutti gli importi e un riepilogo per la tua dichiarazione.
                      </p>
                    </CardContent>
                  </Card>
                </div>
            ...
            <div className="container">
              <div className="max-w-5xl mx-auto">
                <div className="text-center mb-10">
                  <h2 className="text-3xl md:text-4xl font-bold mb-4">Calcolatore IVA</h2>
                  <p className="text-lg text-muted-foreground">
                    Calcola istantaneamente l'IVA per le tue transazioni internazionali
                  </p>
                </div>
                  ...
                  <Card className="border-2 shadow-lg">
                    <CardHeader className="space-y-1 pb-4">
                      ...
                      <CardDescription className="text-base">
                        Compila i campi sottostanti per calcolare l'IVA
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                      <div className="space-y-3">
                        ...
                        <Select onValueChange={handleCountryChange}>
                          <SelectTrigger id="country" className="h-14 text-base">
                            <SelectValue placeholder="Scegli un paese..." />
                          </SelectTrigger>
                      ...
                      {selectedCountry && (
                        <>
                            ...
                            >
                              <div className="flex items-center space-x-2 p-3 rounded-lg border bg-card hover:bg-accent/50 transition-colors">
                                ...
                                <Label htmlFor="standard" className="cursor-pointer flex-1 font-medium">
                                  Aliquota ordinaria: {selectedCountry.standardRate}%
                                </Label>
                              </div>
                          ...
                          <div className="space-y-3">
                            <Label className="text-base font-semibold">L'importo è:</Label>
                          ...
                          <div className="space-y-3">
                            <Label htmlFor="amount" className="text-base font-semibold">
                              ...
                              Importo ({selectedCountry.currencySymbol})
                            </Label>
                      ...
                      {!selectedCountry && (
                        <div className="text-center py-12 px-4">
                          ...
                          <p className="text-lg text-muted-foreground font-medium">
                            Seleziona un paese per iniziare
                          </p>
                          <p className="text-sm text-muted-foreground mt-2">
                            Scegli tra 60+ paesi nel mondo
                          </p>
                        </div>
                      )}
                    </CardContent>
                    ...
                    <Card className="flex items-center justify-center border-2 shadow-lg">
                      <CardContent className="text-center py-16 px-6">
                        ...
                        <p className="text-lg text-muted-foreground font-medium mb-2">
                          Inserisci i dati per calcolare l'IVA
                        </p>
