...
const premiumDomains = [
  ...
  {
    name: "imess.eu",
    description: "Domena EU z backlinkami z Bit.ly, Wikipedia (JA), UCL i Uniwersytet Helsinki.",
    mozScore: 31,
    pageAuthority: 32,
    linkingDomains: 174,
    inboundLinks: "748+",
  ...
  {
    name: "dowse.eu",
    description: "Domena EU z backlinkami z GitHub, Medium, The Guardian i Vercel.",
    mozScore: 30,
    pageAuthority: 33,
    linkingDomains: 184,
    inboundLinks: "853+",
  ...
  {
    name: "scpenetwork.eu",
    description: "Domena sieciowa EU z backlinkami z Springer, The Conversation, MDPI i Player.fm.",
    mozScore: 28,
    pageAuthority: 30,
    linkingDomains: 131,
    inboundLinks: "280+",
  ...
  {
    name: "papilios.eu",
    description: "Domena EU z wysokimi linking domains i backlinkami z Zoznam.sk, Centrum.cz i Penize.cz.",
    mozScore: 28,
    pageAuthority: 32,
    linkingDomains: 833,
    inboundLinks: "20.2K+",
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://www.iaee.eu/expireddomainnames/pl/kup-domeny-premium-wysoki-autorytet-wartosc-seo" />
        ...
        <meta property="og:url" content="https://www.iaee.eu/expireddomainnames/pl/kup-domeny-premium-wysoki-autorytet-wartosc-seo" />
        ...
        <meta property="og:image:alt" content="Domeny Premium - Nazwy Domen Wysokiego Autorytetu" />
                ...
                >
                  <CardHeader className="p-3 sm:p-4 pb-2 sm:pb-3">
                    <div className="mt-1 mb-2 flex justify-center">
                      <img src="/images/premium-domains-logo-pl.png" alt={`Kup ${domain.name} - Premium wygasła domena z wysokim autorytetem MOZ & wartością SEO dla każdej strony`} className="w-20 h-auto object-contain" />
                    </div>
