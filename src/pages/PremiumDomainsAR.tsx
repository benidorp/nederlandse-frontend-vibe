...
const premiumDomains = [
  ...
  {
    name: "imess.eu",
    description: "نطاق أوروبي مع روابط خلفية من Bit.ly وWikipedia (JA) وUCL وجامعة هلسنكي.",
    mozScore: 31,
    pageAuthority: 32,
    linkingDomains: 174,
    inboundLinks: "748+",
  ...
  {
    name: "dowse.eu",
    description: "نطاق أوروبي مع روابط خلفية من GitHub وMedium وThe Guardian وVercel.",
    mozScore: 30,
    pageAuthority: 33,
    linkingDomains: 184,
    inboundLinks: "853+",
  ...
  {
    name: "scpenetwork.eu",
    description: "نطاق شبكة أوروبي مع روابط خلفية من Springer وThe Conversation وMDPI وPlayer.fm.",
    mozScore: 28,
    pageAuthority: 30,
    linkingDomains: 131,
    inboundLinks: "280+",
  ...
  {
    name: "papilios.eu",
    description: "نطاق أوروبي مع نطاقات ربط عالية وروابط خلفية من Zoznam.sk وCentrum.cz وPenize.cz.",
    mozScore: 28,
    pageAuthority: 32,
    linkingDomains: 833,
    inboundLinks: "20.2K+",
              ...
              },
              {
                ...
                "itemListElement": ${JSON.stringify(premiumDomains.slice(0, 10).map((domain, index) => ({
                  ...
                  "item": {
                    ...
                    "url": "https://www.iaee.eu/expireddomainnames/ar/shira-nitaqat-muntahiya-seo",
                    "sku": domain.name,
                    "brand": {
                      "@type": "Brand",
                      "name": "IAEE Premium Domains"
              ...
              {premiumDomains.map((domain, index) => (
                ...
                >
                  <CardHeader className="pb-2 sm:pb-3 p-3 sm:p-4 md:p-6">
                    ...
                    <CardTitle className="text-lg sm:text-xl md:text-2xl text-white group-hover:text-amber-400 transition-colors mt-2 sm:mt-3 break-all" dir="ltr">
                      {domain.name}
                    </CardTitle>
