            ...
            <div className="container relative z-10">
              <div className="max-w-5xl mx-auto text-center">
                ...
                <p className="text-xl md:text-2xl text-muted-foreground mb-4 leading-relaxed">
                  Protect your online business with professionally crafted legal documents. GDPR-compliant, ready to
                  use, and specifically tailored for your website type.
                </p>

                <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed max-w-3xl mx-auto">
                  Whether you're running an e-commerce store, affiliate website, photography business, or any other
                  online venture, we provide comprehensive legal protection that's both affordable and easy to
                  implement. No legal expertise required – just download, customize with your business details, and
                  you're protected.
                </p>
                ...
                <p className="text-base text-muted-foreground mb-8">
                  Choose your website type below and get instant access to all the legal documents you need to operate
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="order-2 lg:order-1">
                  ...
                  <p className="text-xl text-slate-300 mb-6 leading-relaxed">
                    Boost your website's SEO rankings instantly with our curated collection of high-authority expired
                    domain names. Each domain comes with proven backlinks and established domain authority.
                  </p>
                  ...
                  <div className="flex flex-wrap gap-4">
                    ...
                    <Link to="/expireddomainnames/nl/premium-domeinnamen-kopen-hoge-autoriteit-seo-waarde">
                      <Button
                        size="lg"
                        variant="outline"
                        className="border-slate-500 text-slate-300 hover:bg-slate-700 text-lg px-8"
                      >
                        Nederlandse versie
                      </Button>
                    </Link>
                  ...
                  <CardContent className="p-8">
                    <div className="flex flex-col md:flex-row items-center gap-6">
                      ...
                      <div className="flex-1 text-center md:text-left">
                        <h2 className="text-2xl md:text-3xl font-bold mb-2">Wereldwijde BTW-calculator</h2>
                        <p className="text-muted-foreground mb-4">
                          Bereken eenvoudig BTW voor meer dan 40 landen wereldwijd. Professionele tool voor
          ...
          <section className="py-16 md:py-24 bg-gradient-to-b from-primary/5 to-background">
            <div className="container">
              <div className="max-w-3xl mx-auto text-center">
                <h2 className="text-3xl md:text-4xl font-bold mb-4">Still Not Sure Which Package You Need?</h2>
                <p className="text-lg text-muted-foreground mb-8">
                  Every package includes comprehensive legal protection tailored to your specific business model. All
                  documents are written by legal professionals and regularly updated to comply with current
                  regulations.Price 79{" "}
                </p>
