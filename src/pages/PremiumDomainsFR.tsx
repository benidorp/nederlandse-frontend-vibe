...
const premiumDomains = [
  ...
  {
    name: "eshcc.eu",
    description: "Domaine EU culture avec des backlinks de Wikipedia (EN, ES, FR, RU), CreativeCommons.",
    mozScore: 22,
    pageAuthority: 28,
    linkingDomains: 171,
    inboundLinks: "4.9K+",
  ...
  },
  {
    ...
    description: "Domaine relations internationales avec des backlinks de Wikipedia (EN, ES, FR, ZH), Cambridge et The Diplomat.",
    mozScore: 23,
    pageAuthority: 23,
    linkingDomains: 65,
    inboundLinks: "184+",
