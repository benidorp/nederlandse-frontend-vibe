...
const premiumDomains = [
  ...
  {
    name: "futurehome.eu",
    description: "Europa.eu, GitHub, Google Sites, Picasa और Campaign Archive से बैकलिंक्स के साथ स्मार्ट होम/तकनीक EU डोमेन।",
    mozScore: 26,
    pageAuthority: 23,
    linkingDomains: 101,
    inboundLinks: "3.6K+",
    followedLinks: "3.6K+",
    category: "स्मार्ट होम",
    price: "€329",
    stripePaymentLink: "https://buy.stripe.com/fZufZhbdJ5mu8CVe549Zm08",
    backlinks: "3.6K+",
    topBacklinks: ["europa.eu (DA 97)", "github.com (DA 96)", "sites.google.com (DA 96)", "picasa.com (DA 89)", "campaign-archive.com (DA 84)"]
  },
  {
    name: "bfrqda.nl",
    description: "RUG, NU.nl और Wetenschapsagenda से बैकलिंक्स के साथ डच अकादमिक डोमेन।",
    mozScore: 26,
    pageAuthority: 24,
    linkingDomains: 34,
    inboundLinks: "148+",
  ...
  {
    name: "eurolicensing.eu",
    description: "Wikipedia (EN, ES, FR, RU), CreativeCommons और Wikiwand से बैकलिंक्स के साथ EU लाइसेंसिंग/संस्कृति डोमेन।",
    mozScore: 22,
    pageAuthority: 32,
    linkingDomains: 810,
    inboundLinks: "4.9K+",
