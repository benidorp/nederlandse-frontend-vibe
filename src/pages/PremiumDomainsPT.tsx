...
const premiumDomains = [
  ...
  },
  {
    ...
    price: "€125",
    backlinks: "1.1K+",
    topBacklinks: ["mdpi.com (DA 92)", "itacyl.es (DA 68)", "csic.es (DA 78)"],
    stripePaymentLink: "https://buy.stripe.com/cNi3cv81xg18g5nf989Zm06"
  },
  {
    name: "documentlocation.co.uk",
    description: "Domínio britânico de documentação/localização com backlinks da Springer, SlidePlayer, Scribd e Farnborough Airshow.",
    mozScore: 22,
    pageAuthority: 24,
    linkingDomains: 63,
    inboundLinks: "231+",
    ...
    price: "€79",
    backlinks: "231+",
    topBacklinks: ["springer.com (DA 93)", "slideplayer.com (DA 91)", "scribd.com (DA 90)", "farnboroughairshow.com (DA 73)"],
    stripePaymentLink: "https://buy.stripe.com/7sY28rdlR9CK2exf989Zm05"
  },
  {
    name: "filmlab.nl",
    description: "Domínio holandês de filme/media com backlinks da UNESCO, WUR, JouwWeb e Startpagina.",
    mozScore: 21,
    pageAuthority: 23,
    linkingDomains: 56,
    inboundLinks: "496+",
                    ...
                    <div className="mt-auto pt-4 border-t border-slate-700/50">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button 
                          size="sm"
                          asChild
                          className="flex-1 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-slate-950 font-semibold"
                        >
