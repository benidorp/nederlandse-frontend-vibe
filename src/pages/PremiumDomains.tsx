                          ...
                          <div className="flex flex-col items-center gap-2 text-center">
                            <div className="flex items-center justify-center gap-1.5 flex-wrap">
                              ...
                              <div className="flex items-center bg-[#003087] rounded px-2 py-1">
                                <span className="text-white font-bold text-xs italic" style={{fontFamily: 'Arial'}}>Pay</span>
                                <span className="text-[#00ADEF] font-bold text-xs italic" style={{fontFamily: 'Arial'}}>Pal</span>
                              </div>
