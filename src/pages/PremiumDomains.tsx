                        ...
                        <div className="flex flex-col gap-3">
                          ...
                          <div className="flex flex-col items-center gap-2 text-center">
                            <div className="flex items-center justify-center gap-1.5 flex-wrap">
                              ...
                              <div className="flex items-center bg-[#1A1F71] rounded px-2 py-1">
                                <span className="text-white font-bold text-xs italic tracking-tight" style={{fontFamily: 'Arial'}}>VISA</span>
                              </div>
                              {/* Mastercard - Clear circles */}
                              <div className="flex items-center bg-[#000000] rounded px-2 py-1">
                                <svg className="h-4 w-6" viewBox="0 0 32 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              {/* PayPal - Authentic logo */}
                              <div className="flex items-center bg-white border border-slate-200 rounded px-2 py-1">
                                <svg className="h-4 w-10" viewBox="0 0 100 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M12.5 4H7.8C7.4 4 7 4.3 6.9 4.7L4.8 18.7C4.8 19 5 19.2 5.3 19.2H7.6C8 19.2 8.4 18.9 8.4 18.5L9 14.8C9.1 14.4 9.4 14.1 9.9 14.1H12.1C16.6 14.1 19.2 11.9 19.9 7.6C20.2 5.8 19.9 4.3 19 3.3C18 2.2 16.2 4 12.5 4ZM13.3 8C12.9 10.6 10.9 10.6 9 10.6H7.9L8.7 5.4C8.7 5.2 8.9 5 9.1 5H9.6C10.9 5 12.1 5 12.8 5.7C13.2 6.2 13.4 6.9 13.3 8Z" fill="#003087"/>
                                  <path d="M35.5 7.9H33.2C33 7.9 32.8 8.1 32.7 8.3L32.6 9L32.4 8.7C31.7 7.7 30.2 7.4 28.7 7.4C25.2 7.4 22.2 10.1 21.6 13.8C21.3 15.6 21.7 17.4 22.7 18.6C23.6 19.7 24.9 20.2 26.4 20.2C29 20.2 30.5 18.5 30.5 18.5L30.4 19.2C30.3 19.5 30.5 19.7 30.8 19.7H32.9C33.3 19.7 33.7 19.4 33.8 19L35.2 9.3C35.3 9 35.1 8.8 35.5 7.9ZM31.4 14C31.1 15.7 29.7 16.9 28 16.9C27.1 16.9 26.4 16.6 26 16.1C25.6 15.6 25.4 14.8 25.5 14C25.7 12.3 27.2 11.1 28.9 11.1C29.8 11.1 30.5 11.4 30.9 11.9C31.3 12.5 31.5 13.2 31.4 14Z" fill="#003087"/>
                                  <path d="M54.5 7.9H52.1C51.9 7.9 51.6 8 51.5 8.2L48.8 12.4L47.7 8.4C47.6 8.1 47.3 7.9 47 7.9H44.7C44.4 7.9 44.2 8.2 44.3 8.5L46.6 17.8L44.4 21C44.2 21.3 44.4 21.7 44.8 21.7H47.2C47.4 21.7 47.7 21.6 47.8 21.4L55 8.6C55.2 8.3 55 7.9 54.5 7.9Z" fill="#003087"/>
                                  <path d="M62.5 4H57.8C57.4 4 57 4.3 56.9 4.7L54.8 18.7C54.8 19 55 19.2 55.3 19.2H57.8C58.1 19.2 58.3 19 58.4 18.8L59 14.8C59.1 14.4 59.4 14.1 59.9 14.1H62.1C66.6 14.1 69.2 11.9 69.9 7.6C70.2 5.8 69.9 4.3 69 3.3C68 2.2 66.2 4 62.5 4ZM63.3 8C62.9 10.6 60.9 10.6 59 10.6H57.9L58.7 5.4C58.7 5.2 58.9 5 59.1 5H59.6C60.9 5 62.1 5 62.8 5.7C63.2 6.2 63.4 6.9 63.3 8Z" fill="#009CDE"/>
                                  <path d="M85.5 7.9H83.2C83 7.9 82.8 8.1 82.7 8.3L82.6 9L82.4 8.7C81.7 7.7 80.2 7.4 78.7 7.4C75.2 7.4 72.2 10.1 71.6 13.8C71.3 15.6 71.7 17.4 72.7 18.6C73.6 19.7 74.9 20.2 76.4 20.2C79 20.2 80.5 18.5 80.5 18.5L80.4 19.2C80.3 19.5 80.5 19.7 80.8 19.7H82.9C83.3 19.7 83.7 19.4 83.8 19L85.2 9.3C85.3 9 85.1 8.8 85.5 7.9ZM81.4 14C81.1 15.7 79.7 16.9 78 16.9C77.1 16.9 76.4 16.6 76 16.1C75.6 15.6 75.4 14.8 75.5 14C75.7 12.3 77.2 11.1 78.9 11.1C79.8 11.1 80.5 11.4 80.9 11.9C81.3 12.5 81.5 13.2 81.4 14Z" fill="#009CDE"/>
                                  <path d="M88.5 4.5L86.3 18.7C86.3 19 86.5 19.2 86.8 19.2H88.8C89.2 19.2 89.6 18.9 89.7 18.5L91.8 4.5C91.8 4.2 91.6 4 91.3 4H89C88.8 4 88.6 4.2 88.5 4.5Z" fill="#009CDE"/>
                                </svg>
                              </div>
