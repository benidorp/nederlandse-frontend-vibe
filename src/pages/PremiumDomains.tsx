                        ...
                        <div className="flex flex-col gap-3">
                          ...
                          <div className="flex flex-col items-center gap-1.5 text-center">
                            <div className="flex items-center justify-center gap-1 flex-wrap">
                              {/* Apple Pay */}
                              <div className="flex items-center bg-black rounded px-1.5 py-0.5">
                                <svg className="h-3 w-8" viewBox="0 0 50 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div className="flex items-center bg-white rounded px-1.5 py-0.5 border border-slate-300">
                                <svg className="h-3 w-12" viewBox="0 0 65 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              {/* Klarna */}
                              <div className="flex items-center bg-[#FFB3C7] rounded px-1.5 py-0.5">
                                <span className="text-black font-bold text-[10px]" style={{fontFamily: 'Arial'}}>Klarna</span>
                              </div>
                            </div>
                        ...
                        <div className="flex flex-col gap-3">
                          ...
                          <div className="flex flex-col items-center gap-2 text-center">
                            <div className="flex items-center justify-center gap-1 flex-wrap">
                              ...
                              <div className="flex items-center bg-[#1A1F71] rounded px-1.5 py-0.5">
                                <span className="text-white font-bold text-[10px] italic tracking-tight" style={{fontFamily: 'Arial'}}>VISA</span>
                              </div>
                              {/* Mastercard - Clear circles */}
                              <div className="flex items-center bg-[#000000] rounded px-1.5 py-0.5">
                                <svg className="h-3 w-5" viewBox="0 0 32 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div className="flex items-center bg-[#003087] rounded px-1.5 py-0.5">
                                <span className="text-white font-bold text-[10px] italic" style={{fontFamily: 'Arial'}}>Pay</span>
                                <span className="text-[#00ADEF] font-bold text-[10px] italic" style={{fontFamily: 'Arial'}}>Pal</span>
                              </div>
