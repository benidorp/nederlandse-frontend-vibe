...
const premiumDomains = [
  ...
  },
  {
    ...
    stripePaymentLink: "https://buy.stripe.com/fZu6oH6Xt3emg5n5yy9Zm0a",
    backlinks: "97+",
    topBacklinks: ["ow.ly (DA 94)", "euractiv.com (DA 84)", "danfoss.com (DA 66)", "airah.org.au (DA 45)"]
  },
  {
    name: "newbiz.eu",
    description: "Business/Startup-EU-Domain mit Backlinks von Europa.eu, Livejournal, Storify und SlideShare.",
    mozScore: 30,
    pageAuthority: 22,
    linkingDomains: 78,
    inboundLinks: "162+",
    ...
    stripePaymentLink: "https://buy.stripe.com/fZu6oH6Xt3emg5n5yy9Zm0a",
    backlinks: "162+",
    topBacklinks: ["europa.eu (DA 97)", "livejournal.com (DA 95)", "storify.com (DA 90)", "slideshare.net (DA 94)", "euractiv.com (DA 84)"]
  },
  // DA 29
  {
    name: "lifewatch.eu",
    description: "Umwelt/Biodiversitäts-Forschungsprojekt-Domain mit Backlinks von Europa.eu, GitHub, Nature und Springer.",
    mozScore: 29,
    pageAuthority: 37,
    linkingDomains: 742,
    inboundLinks: "26.9K+",
    ...
    category: "Forschung",
    price: "€495",
    stripePaymentLink: "https://buy.stripe.com/eVq9ATdlRg18g5ncoo9Zm0n",
    backlinks: "26.9K+",
    topBacklinks: ["europa.eu (DA 97)", "github.com (DA 96)", "nature.com (DA 95)", "springer.com (DA 93)", "mdpi.com (DA 92)"]
  },
  {
    name: "houseofcompounding.com",
    description: "Finanzen/Investment-Domain mit Backlinks von Forbes, The Guardian, Standard.co.uk, Timeout und The Times.",
    mozScore: 29,
    pageAuthority: 24,
    linkingDomains: 63,
    inboundLinks: "167+",
  ...
  },
  {
    ...
    price: "€125",
    backlinks: "294+",
    topBacklinks: ["europa.eu (DA 97)", "bit.ly (DA 94)", "ask.com (DA 88)", "campaign-archive.com (DA 84)", "deltares.nl (DA 63)"],
    stripePaymentLink: "https://buy.stripe.com/cNi3cv81xg18g5nf989Zm06"
  },
  // DA 21
  {
    name: "truffelnl.nl",
    description: "Niederländische Lebensmittel/Trüffel-Domain mit Backlinks von UNESCO, WUR, Jouwweb und Startpagina.",
    mozScore: 21,
    pageAuthority: 25,
    linkingDomains: 95,
    inboundLinks: "496+",
                      ...
                      {domain.stripePaymentLink ? (
                        <div className="space-y-2">
                          <a 
                            ...
                            className="w-full inline-flex items-center justify-center gap-2 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-slate-950 font-semibold py-3 px-4 rounded-lg transition-all hover:shadow-lg hover:shadow-amber-500/25"
                          >
                            <Lock className="w-4 h-4" />
                            Jetzt kaufen
                          </a>
                          <div className="flex items-center justify-center gap-2 text-xs text-slate-500">
                            <span>Sichere Zahlung über</span>
                            <img src={stripeLogo} alt="Stripe" className="h-5" />
                          </div>
                          <div className="bg-slate-800/60 rounded-lg p-3 border border-slate-700/50">
                            <p className="text-[11px] text-slate-400 leading-relaxed">
                              <CheckCircle className="w-3 h-3 inline mr-1 text-amber-400" />
