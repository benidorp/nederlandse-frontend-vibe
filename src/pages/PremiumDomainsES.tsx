...
const premiumDomains = [
  ...
  {
    name: "aedifion.eu",
    description: "Dominio tech UE con backlinks de YouTube, Greentech Media y FAZ.",
    mozScore: 22,
    pageAuthority: 22,
    linkingDomains: 56,
    inboundLinks: "96+",
    ...
    price: "€125",
    backlinks: "96+",
    topBacklinks: ["youtube.com (DA 100)", "greentechmedia.com (DA 79)", "faz.net (DA 91)"],
    stripePaymentLink: "https://buy.stripe.com/cNi3cv81xg18g5nf989Zm06"
  },
  {
    name: "music-for-books.eu",
    description: "Dominio de entretenimiento EU con backlinks de Wikipedia (EN, ES, FR, RU), CreativeCommons y IMDB.",
    mozScore: 22,
    pageAuthority: 23,
    linkingDomains: 94,
    inboundLinks: "4.9K+",
  ...
  },
  {
    ...
    description: "Dominio de relaciones internacionales con backlinks de Wikipedia (EN, ES, FR, ZH), Cambridge y The Diplomat.",
    mozScore: 23,
    pageAuthority: 23,
    linkingDomains: 65,
    inboundLinks: "184+",
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <header className="sticky top-0 z-50 backdrop-blur-xl bg-slate-950/80 border-b border-amber-500/20">
          <div className="container mx-auto px-4 py-4 flex items-center justify-between">
            <RouterLink to="/expireddomainnames/es/comprar-dominios-premium-alta-autoridad-valor-seo" className="flex items-center gap-3">
