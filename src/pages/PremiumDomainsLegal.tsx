  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://iaee.eu/expireddomainnames/nl/premium-domeinnamen-juridische-documenten" />
      </Helmet>
        ...
        <header className="py-6 border-b border-slate-800 bg-slate-950/80 backdrop-blur-sm sticky top-0 z-50">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between">
              <Link to="/expireddomainnames/nl/premium-domeinnamen-kopen-hoge-autoriteit-seo-waarde" className="flex items-center gap-3">
