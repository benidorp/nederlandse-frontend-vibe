        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8">
            ...
            <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg border border-blue-100">
              ...
              <span className="text-sm font-medium text-slate-700">Αξιόπιστο από 500+ ιστοσελίδες</span>
            </div>

            {/* Main Headline */}
            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                <span className="text-slate-800">Απαραίτητα</span>
                <br />
                <span className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent">
                  Νομικά Έγγραφα
                </span>
                <br />
                <span className="text-slate-800">για Ιστοσελίδες</span>
              </h1>
              <p className="text-xl text-slate-600 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                Πλήρες πακέτο συμμόρφωσης για ιστοσελίδες — Όροι & Προϋποθέσεις, Πολιτική Απορρήτου, Πολιτική Cookies, Γνωστοποίηση Συνεργατών και Αποποίηση Ευθύνης.
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-3 justify-center lg:justify-start">
              <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm px-4 py-2 rounded-full border border-slate-200">
                ...
                <span className="text-sm font-medium text-slate-700">5 Νομικά Πρότυπα</span>
              </div>
              <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm px-4 py-2 rounded-full border border-slate-200">
                <Shield className="w-4 h-4 text-green-500" />
                <span className="text-sm font-medium text-slate-700">Συμβατό με GDPR</span>
              </div>
              <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm px-4 py-2 rounded-full border border-slate-200">
                <Scale className="w-4 h-4 text-purple-500" />
                <span className="text-sm font-medium text-slate-700">Συμβατό με FTC</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-6 justify-center lg:justify-start text-sm text-slate-500">
              <div className="flex items-center gap-1">
                ...
                <span>4.9/5 Βαθμολογία</span>
              </div>
              <div className="h-4 w-px bg-slate-300"></div>
              <span>Άμεση Λήψη</span>
              <div className="h-4 w-px bg-slate-300"></div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-slate-800">Νομικό Πακέτο</h3>
                        <p className="text-sm text-slate-500">5 Έγγραφα Περιλαμβάνονται</p>
                      </div>
                    </div>
                  ...
                  <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-4 text-center text-white">
                    <p className="text-sm opacity-90">Πλήρες Πακέτο</p>
                    <p className="text-3xl font-bold">€79</p>
                    <p className="text-sm opacity-90">Εφάπαξ Πληρωμή</p>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -top-6 -left-6 bg-white rounded-2xl shadow-xl p-4 transform -rotate-6">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">Συμμόρφωση</p>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -bottom-4 -right-4 bg-white rounded-2xl shadow-xl p-4 transform rotate-6">
                <div className="flex items-center gap-2">
                  <div className="flex -space-x-2">
                    <img src={nicoleProfile} alt="Χρήστης" className="w-8 h-8 rounded-full border-2 border-white object-cover" />
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">Πελάτες</p>
                  </div>
                </div>
              </div>
            </div>
