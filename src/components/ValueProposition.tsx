      ...
      <div className="container">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="mt-10 p-8 bg-primary-foreground rounded-xl border border-primary-foreground/50 shadow-sm text-foreground">
              <div className="text-center mb-6">
                <h3 className="text-2xl font-bold text-foreground mb-2">Over Mij</h3>
                <p className="text-2xl font-bold text-navy mb-2">Nicole Henderson</p>
          ...
          <Card className="mb-8 border-2 border-primary-foreground/30 bg-primary-foreground text-foreground">
            <CardHeader>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-4 mt-6">
                <div className="flex items-start gap-3 p-4 rounded-lg bg-background border border-navy/20">
                  ...
                  <div>
                    <h4 className="font-semibold mb-1 text-foreground">AVG/GDPR Privacybeleid</h4>
                    <p className="text-sm text-foreground/80">Volledig conform Europese wetgeving, inclusief cookiegebruik en gegevensbescherming</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-background border border-navy/20">
                  <CheckCircle className="h-5 w-5 text-navy mt-0.5 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold mb-1 text-foreground">Affiliate Disclosure</h4>
                    <p className="text-sm text-foreground/80">Transparante melding dat je commissies verdient, conform FTC en EU regelgeving</p>
                  </div>
                </div>
