      ...
      <div className="container">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            Essential Dropshipping Legal Documents
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Complete package with all legal documents you need for your dropshipping business. Download instantly 
            in your preferred language—or multiple languages—and make your dropshipping store legally compliant worldwide.
          </p>
        </div>
          ...
          <Card className="border-primary shadow-xl">
            <CardHeader className="text-center pb-8">
              ...
              <CardDescription className="text-base">
                All essential legal documents for unlimited use across your dropshipping stores
              </CardDescription>
            </CardHeader>
...
export default PricingDropshipping;
