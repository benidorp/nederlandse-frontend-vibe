    ...
    >
      <div className="container relative z-10 text-center py-20">
        ...
        <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto text-white/90">
          Protect your dropshipping business with professionally crafted legal documents. 
          GDPR-compliant policies, clear terms & conditions, and supplier agreements—all ready to implement immediately.
        </p>
