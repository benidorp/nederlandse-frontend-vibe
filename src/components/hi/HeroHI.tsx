      ...
      <div className="container grid lg:grid-cols-2 gap-8 items-center py-12">
        <div className="space-y-6">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-primary-foreground leading-tight">
            एफिलिएट वेबसाइटों के लिए कानूनी दस्तावेज़: नियम और शर्तें, गोपनीयता नीति, प्रकटीकरण और कुकी नीति
          </h1>
          
          <p className="text-lg text-primary-foreground/90 leading-relaxed">
            पेशेवर कानूनी दस्तावेज़ जो आपके एफिलिएट व्यवसाय की रक्षा करते हैं और सभी कानूनी आवश्यकताओं का अनुपालन सुनिश्चित करते हैं।
            हमारे किफायती पैकेज में <strong>नियम और शर्तें, गोपनीयता नीति और अस्वीकरण</strong> जैसे सभी आवश्यक समझौते शामिल हैं—
            पूर्ण अनुपालन, विश्वास और मन की शांति के लिए।
          </p>
