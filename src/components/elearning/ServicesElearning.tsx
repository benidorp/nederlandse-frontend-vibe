...
const ServicesElearning = () => {
  return <section id="services" className="py-20 bg-gradient-to-br from-background via-accent/5 to-background">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-primary via-primary/80 to-accent bg-clip-text text-transparent">Everything Your E-Learning website Platform Needs</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            return <Card key={index} className="border-2 border-primary/20 hover:border-primary/40 shadow-lg hover:shadow-2xl transition-all transform hover:scale-105 hover:-translate-y-1 bg-gradient-to-br from-card to-card/50">
                  <CardHeader>
