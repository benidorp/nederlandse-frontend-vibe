        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-left">
              ...
              {/* Main heading */}
              <h1 className="text-4xl font-bold mb-6 bg-gradient-to-r from-primary via-primary/80 to-accent bg-clip-text text-transparent animate-fade-in leading-tight md:text-4xl">Essential Website Legal Protection for E-Learning & Online Course : Terms & Conditions, Privacy Policy, Refund Policy & GDPR Compliance</h1>
              ...
              <div className="grid grid-cols-1 gap-3 mb-10 animate-fade-in">
                {["Course Terms & Conditions", "Student Privacy Protection", "Intellectual Property Rights", "100% GDPR Compliant"].map((item, index) => <div key={index} className="flex items-center gap-2 bg-card/50 backdrop-blur px-4 py-2 rounded-lg border border-primary/20 shadow-sm hover:shadow-md transition-all">
            ...
            <div className="relative animate-fade-in">
              <div className="relative">
                ...
                <img src={nicoleWorking} alt="Nicole Henderson - E-Learning Legal Specialist" className="relative rounded-3xl shadow-2xl w-full h-auto border-4 border-primary/20" />
