...
const translations = {
  nl: {
    ...
    premiumDomainsDesc:
    "Koop krachtige verlopen domeinnamen met hoge MOZ autoriteit en sterke kwalitatieve backlinks. Boost je SEO rank sneller in Google en bespaar maanden aan linkbuilding.",
    ...
    legalDocsDesc:
    "Bescherm je online website business met professionele algemene voorwaarden, privacybeleid, cookie policy en meer. Voldoe aan wetgeving, voorkom risico's en straal vertrouwen uit naar je klanten",
