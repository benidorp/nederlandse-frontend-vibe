      ...
      <div className="container grid lg:grid-cols-2 gap-8 items-center py-12">
        <div className="space-y-6">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-primary-foreground leading-tight">
            Documentos Legais para Sites de Afiliados: Termos e Condições, Política de Privacidade, Divulgação & Política de Cookies
          </h1>
          
          <p className="text-lg text-primary-foreground/90 leading-relaxed">
            Documentos legais profissionais que protegem o seu negócio de afiliados e garantem a conformidade com todos os requisitos legais. 
            O nosso pacote acessível inclui todos os acordos essenciais como <strong>termos e condições, política de privacidade e isenções de responsabilidade</strong>—
            para conformidade completa, confiança e tranquilidade.
          </p>
        ...
        <div className="relative">
          ...
          <img 
            src={heroImage} 
            alt="Consultor jurídico profissional" 
