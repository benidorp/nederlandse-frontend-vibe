      ...
      <div className="container grid lg:grid-cols-2 gap-8 items-center py-12">
        <div className="space-y-6">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-primary-foreground leading-tight">
            Dokumenty Prawne dla Stron Afiliacyjnych: Regulamin, Polityka Prywatności, Ujawnienie & Polityka Cookies
          </h1>
          
          <p className="text-lg text-primary-foreground/90 leading-relaxed">
            Profesjonalne dokumenty prawne, które chronią Twoją działalność afiliacyjną i zapewniają zgodność ze wszystkimi wymogami prawnymi. 
            Nasz przystępny cenowo pakiet zawiera wszystkie niezbędne umowy, takie jak <strong>regulamin, polityka prywatności i wyłączenia odpowiedzialności</strong>—
            dla pełnej zgodności, zaufania i spokoju ducha.
          </p>
        ...
        <div className="relative">
          ...
          <img 
            src={heroImage} 
            alt="Profesjonalny konsultant prawny" 
