      ...
      <div className="container">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            Essential Streaming Platform Documents
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Complete package with all legal documents you need for your streaming and media platform. Download the package easily in your own language – or in multiple languages – and make your platform ready for international use.
          </p>
        </div>
...
export default PricingStreamingMedia;
