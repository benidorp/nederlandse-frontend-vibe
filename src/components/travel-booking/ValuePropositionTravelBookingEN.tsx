        ...
        <div className="mb-12">
          ...
          <Card className="bg-primary text-primary-foreground">
            <CardContent className="pt-6">
              ...
              <p className="text-lg mb-6">For only one-time payment you arrange all legal obligations for all your travel and booking websites. No monthly fees, no hassle with lawyers, no risk of fines. Just all the documents you need, ready to use.</p>
