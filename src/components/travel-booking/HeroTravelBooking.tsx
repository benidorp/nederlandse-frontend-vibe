      ...
      <div className="container grid lg:grid-cols-2 gap-8 items-center py-12">
        <div className="space-y-6">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-primary-foreground leading-tight">
            Juridische Documenten voor Reisboekings- en Hotelwebsites: Algemene voorwaarden, Privacybeleid, Annuleringsbeleid & Disclaimer
          </h1>
          
          <p className="text-lg text-primary-foreground/90 leading-relaxed">
            Professionele juridische documenten die uw reisboekingsplatform beschermen en in lijn brengen met alle wettelijke vereisten. 
            Ons betaalbare pakket bevat alle essentiële documenten zoals <strong>algemene voorwaarden, privacybeleid, annuleringsvoorwaarden en disclaimers</strong>—
        ...
        <div className="relative">
          ...
          <img 
            src={heroImage} 
            alt="Professionele juridische consultant voor reisbranche" 
...
export default HeroTravelBooking;
