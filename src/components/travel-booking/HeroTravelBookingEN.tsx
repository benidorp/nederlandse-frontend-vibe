      ...
      <div className="container grid lg:grid-cols-2 gap-8 items-center py-12">
        <div className="space-y-6">
          ...
          <p className="text-lg text-primary-foreground/90 leading-relaxed">
            Professional legal documents that protect your travel booking platform and ensure compliance with all legal requirements. 
            Our affordable package includes all essential documents such as <strong>terms and conditions, privacy policy, cancellation terms and disclaimers</strong>—
