      ...
      <div className="container grid lg:grid-cols-2 gap-8 items-center py-12">
        <div className="space-y-6">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-primary-foreground leading-tight">
            Juridiske Dokumenter for Affiliate-nettsteder: Vilkår, Personvernregler, Avsløring & Informasjonskapsler
          </h1>
          
          <p className="text-lg text-primary-foreground/90 leading-relaxed">
            Profesjonelle juridiske dokumenter som beskytter din affiliate-virksomhet og sikrer overholdelse av alle juridiske krav. 
            Vår rimelige pakke inkluderer alle nødvendige avtaler som <strong>vilkår og betingelser, personvernregler og ansvarsfraskrivelser</strong>—
            for fullstendig samsvar, tillit og trygghet.
          </p>
        ...
        <div className="relative">
          ...
          <img 
            src={heroImage} 
            alt="Profesjonell juridisk konsulent" 
