      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-sm text-white/70 mb-4">
              Profesjonelle juridiske dokumenter for affiliate-markedsførere. Fullt i samsvar med GDPR og FTC-retningslinjer.
            </p>
          ...
          <div>
            <h3 className="font-semibold mb-4 text-white">Hurtiglenker</h3>
          ...
          <div>
            <h3 className="font-semibold mb-4 text-white">Juridisk Informasjon</h3>
            <ul className="space-y-2">
              <li>
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-white/70">© 2026 Legal Affiliate Agreement. Alle rettigheter forbeholdt.</p>
          </div>
        </div>
      </div>
    </footer>
