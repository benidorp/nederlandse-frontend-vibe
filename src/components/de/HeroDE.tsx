      ...
      <div className="container grid lg:grid-cols-2 gap-8 items-center py-12">
        <div className="space-y-6">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-primary-foreground leading-tight">
            Rechtsdokumente für Affiliate-Websites: AGB, Datenschutzerklärung, Offenlegung & Cookie-Richtlinie
          </h1>
          
          <p className="text-lg text-primary-foreground/90 leading-relaxed">
            Professionelle Rechtsdokumente, die Ihr Affiliate-Business schützen und mit allen gesetzlichen Anforderungen in Einklang bringen. 
            Unser erschwingliches Paket enthält alle wesentlichen Vereinbarungen wie <strong>AGB, Datenschutzrichtlinien und Haftungsausschlüsse</strong>—
            für vollständige Compliance, Vertrauen und Seelenfrieden.
          </p>
