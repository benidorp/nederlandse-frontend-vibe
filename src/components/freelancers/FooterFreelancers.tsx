      ...
      <div className="container py-12">
        ...
        <div className="mt-8 pt-8 border-t">
          ...
          <nav aria-label="All pages" className="grid grid-cols-2 md:grid-cols-3 gap-3">
            ...
            <a href="/expireddomainnames/en/buy-premium-domains-high-authority-seo-value" className="text-sm text-muted-foreground hover:text-primary transition-colors">Premium Domain Names</a>
            <a href="/btw-calculator-wereldwijd" className="text-sm text-muted-foreground hover:text-primary transition-colors">VAT Calculator</a>
          </nav>
        </div>
