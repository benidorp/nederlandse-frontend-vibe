  ...
  return <section className="py-16 bg-secondary/30">
      <div className="container">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Every Freelancer Needs Legal website Documents</h2>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex gap-4 items-start">
                <img src={profileImage} alt="Nicole Henderson - Legal Specialist for Freelancers" className="w-24 h-24 rounded-full object-cover" />
                <div>
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="flex items-start gap-2">
                  <FileText className="h-5 w-5 mt-0.5" style={{
                  color: '#3b82f6'
                }} />
                  <div>
                ...
                <div className="flex items-start gap-2">
                  <Shield className="h-5 w-5 mt-0.5" style={{
                  color: '#3b82f6'
                }} />
                  <div>
                ...
                <div className="flex items-start gap-2">
                  <Scale className="h-5 w-5 mt-0.5" style={{
                  color: '#ef4444'
                }} />
                  <div>
                ...
                <div className="flex items-start gap-2">
                  <CheckCircle2 className="h-5 w-5 mt-0.5" style={{
                  color: '#ef4444'
                }} />
                  <div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          <Card>
            <CardHeader>
              <Clock className="h-8 w-8 mb-2" style={{
              color: '#3b82f6'
            }} />
          ...
          <Card>
            <CardHeader>
              <Globe className="h-8 w-8 mb-2" style={{
              color: '#ef4444'
            }} />
          ...
          <Card>
            <CardHeader>
              <Shield className="h-8 w-8 mb-2" style={{
              color: '#3b82f6'
            }} />
        ...
        <Card className="bg-primary text-primary-foreground">
          <CardContent className="p-8">
            <div className="text-center space-y-4">
              <h3 className="text-2xl font-bold">Complete Legal Package for your website - Just €79</h3>
              <p className="text-lg text-primary-foreground/90">
                Save thousands compared to hiring a lawyer. Get professional protection for your freelance business today.
              </p>
              <Button size="lg" onClick={() => scrollToSection("pricing")} className="bg-primary-foreground text-primary hover:bg-primary-foreground/90">
                Get Started Now
              </Button>
            </div>
          </CardContent>
