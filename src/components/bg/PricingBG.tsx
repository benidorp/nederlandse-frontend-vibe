...
const PricingBG = () => {
  const features = [
    ...
    "Афилиейт Разкриване (FTC Съвместимо)",
    "Отказ от Отговорност",
    "Ръководство за Внедряване",
    "Моментално Изтегляне",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            Еднократно плащане — без абонаменти, без скрити такси
          </p>
        </div>
          ...
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-3xl p-8 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-slate-400">Еднократно плащане</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-center gap-2 text-slate-400 text-sm">
                  ...
                  <span>Сигурно плащане чрез</span>
