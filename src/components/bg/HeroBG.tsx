      ...
      <div className="container grid lg:grid-cols-2 gap-8 items-center py-12">
        <div className="space-y-6">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-primary-foreground leading-tight">
            Правни Документи за Affiliate Уебсайтове: Общи Условия, Политика за Поверителност, Разкриване & Политика за Бисквитки
          </h1>
          <p className="text-lg text-primary-foreground/90 leading-relaxed">
            Професионални правни документи, които защитават вашия affiliate бизнес и осигуряват съответствие с всички правни изисквания.
            Нашият достъпен пакет включва всички основни споразумения като <strong>общи условия, политика за поверителност и отказ от отговорност</strong>—
            за пълно съответствие, доверие и спокойствие.
          </p>
          <div className="flex flex-wrap gap-4">
            <Button size="lg" onClick={() => scrollToSection("pricing")} className="group bg-primary-foreground text-primary hover:bg-primary-foreground/90">
              Вижте Пакетите <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
            </Button>
        ...
        <div className="relative">
          ...
          <img src={heroImage} alt="Професионален юридически консултант" className="relative rounded-lg shadow-2xl w-full object-cover ring-2 ring-primary/10" />
        </div>
      </div>
    </section>
  );
