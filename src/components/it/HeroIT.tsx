      ...
      <div className="container grid lg:grid-cols-2 gap-8 items-center py-12">
        <div className="space-y-6">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-primary-foreground leading-tight">
            Documenti Legali per Siti Web di Affiliazione: Termini e Condizioni, Informativa sulla Privacy, Dichiarazione e Cookie Policy
          </h1>
          
          <p className="text-lg text-primary-foreground/90 leading-relaxed">
            Documenti legali professionali che proteggono la tua attività di affiliazione e garantiscono la conformità a tutti i requisiti legali. 
            Il nostro pacchetto conveniente include tutti gli accordi essenziali come <strong>termini e condizioni, informativa sulla privacy e disclaimer</strong> — 
            per una conformità completa, fiducia e tranquillità.
          </p>
        ...
        <div className="relative">
          ...
          <img 
            src={heroImage} 
            alt="Consulente legale professionista" 
