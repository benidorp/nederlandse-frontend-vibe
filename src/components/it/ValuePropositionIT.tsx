        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
              Tutti i Documenti Legalmente Necessari per il Tuo Sito Web di Affiliazione
            </h2>
            <p className="text-xl text-muted-foreground leading-relaxed">
              Come affiliato marketer, guadagni commissioni raccomandando prodotti. Ma sapevi che sei 
            ...
            <div id="about-me" className="mt-10 p-8 bg-secondary/30 rounded-xl border border-border shadow-sm text-foreground">
              ...
              <div className="space-y-4 text-left max-w-3xl mx-auto">
                <p className="text-base text-muted-foreground leading-relaxed">
                  Ciao, sono Nicole Henderson, una redattrice legale specializzata in documenti legali chiari, accurati e professionali. Redigo contratti, politiche e accordi per aziende, organizzazioni e privati che proteggono i tuoi interessi e garantiscono la conformità, rendendo le pratiche legali semplici e senza stress.
                </p>
                ...
                <div className="pt-4">
                  ...
                  <p className="text-base text-muted-foreground leading-relaxed">
                    Per rispondere alle numerose domande sui requisiti legali per gli affiliati, ho sviluppato documenti legali di alta qualità specificamente per siti web di affiliazione. Questi documenti sono progettati per uso sia nazionale che internazionale e forniscono una protezione essenziale a una frazione del costo abituale. Ottieni una copertura legale professionale a un prezzo accessibile — proteggi la tua attività oggi!
                  </p>
                </div>
              </div>
            </div>
          ...
          <Card className="mb-8 border-2 border-primary/20 bg-primary/5">
            ...
            <CardContent className="space-y-4">
              <p className="text-lg text-muted-foreground">
                Il nostro pacchetto completo contiene <strong>tutti i documenti legali scritti specificamente per siti web di affiliazione</strong>. 
                Non modelli generici, ma testi professionali che si allineano perfettamente al tuo modello di business di affiliazione:
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-4 mt-6">
                <div className="flex items-start gap-3 p-4 rounded-lg bg-secondary/30 border border-primary/10">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Completamente conforme alla legislazione europea, incluso l'uso dei cookie e la protezione dei dati</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-secondary/30 border border-primary/10">
                  <CheckCircle className="h-5 w-5 text-red-600 mt-0.5 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold mb-1">Dichiarazione di Affiliazione</h4>
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-background border border-navy/20">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-foreground/80">Ti protegge dalle richieste di responsabilità e regola il rapporto con i visitatori</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-background border border-navy/20">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-foreground/80">Conforme GDPR, spiegazione dei cookie di tracciamento e analitici</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-background border border-navy/20">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-foreground/80">Istruzioni dettagliate per posizionare tutto correttamente sul tuo sito web</p>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <Card className="border-primary/20 bg-primary/5 text-foreground">
              <CardContent className="pt-6">
                ...
                <h3 className="text-lg font-bold mb-2 text-foreground">Pronto in Minuti</h3>
                <p className="text-sm text-foreground/80">
                  Scarica, inserisci i dettagli della tua attività e posiziona i documenti sul tuo sito web. Nessun avvocato necessario, nessuna settimana di attesa.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-primary/20 bg-primary/5 text-foreground">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Un acquisto, uso illimitato. Utilizza questi documenti per tutti i tuoi siti web di affiliazione attuali e futuri!
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-primary/20 bg-primary/5 text-foreground">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-muted-foreground">
                  I modelli sono disponibili per il download in più lingue per uso internazionale, così puoi distribuirli su tutti i tuoi siti web in tutto il mondo.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <Card className="bg-primary border-2 border-primary text-primary-foreground">
            <CardContent className="pt-6 text-center">
              <h3 className="text-2xl font-bold mb-4 text-primary-foreground">
                Completamente conforme al GDPR e alla legislazione internazionale. Opzione di download in diverse lingue per uso internazionale. Protezione completa per la tua attività.
              </h3>
              <p className="text-lg text-primary-foreground/90 mb-6 max-w-2xl mx-auto">
                Per soli <strong className="text-primary-foreground">€79 una tantum</strong> organizzi tutti gli obblighi legali 
                per tutti i tuoi siti web di affiliazione. Nessun canone mensile, nessun problema con avvocati, nessun rischio di multe. 
