      ...
      <div className="container grid lg:grid-cols-2 gap-8 items-center py-12">
        <div className="space-y-6">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-primary-foreground leading-tight">
            Juridiska Dokument för Affiliate-webbplatser: Villkor, Integritetspolicy, Upplysning & Cookiepolicy
          </h1>
          
          <p className="text-lg text-primary-foreground/90 leading-relaxed">
            Professionella juridiska dokument som skyddar din affiliate-verksamhet och säkerställer efterlevnad av alla juridiska krav. 
            Vårt prisvärda paket inkluderar alla nödvändiga avtal som <strong>villkor, integritetspolicy och ansvarsfriskrivningar</strong>—
            för fullständig efterlevnad, förtroende och sinnesfrid.
          </p>
        ...
        <div className="relative">
          ...
          <img 
            src={heroImage} 
            alt="Professionell juridisk konsult" 
