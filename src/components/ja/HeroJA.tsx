        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left space-y-8">
            <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-full shadow-lg border border-blue-100">
              ...
              <span className="text-sm font-medium text-slate-700">500以上のサイトが信頼</span>
            </div>

            <div className="space-y-4">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                <span className="text-slate-800">ウェブサイト用</span>
                <br />
                <span className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent">
                  必須法的文書
                </span>
                <br />
                <span className="text-slate-800">完全パッケージ</span>
              </h1>
              <p className="text-xl text-slate-600 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                ウェブサイト向け完全コンプライアンスパッケージ — 利用規約、プライバシーポリシー、Cookieポリシー、アフィリエイト開示、免責事項。
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-3 justify-center lg:justify-start">
              <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm px-4 py-2 rounded-full border border-slate-200">
                ...
                <span className="text-sm font-medium text-slate-700">5つの法的テンプレート</span>
              </div>
              <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm px-4 py-2 rounded-full border border-slate-200">
                <Shield className="w-4 h-4 text-green-500" />
                <span className="text-sm font-medium text-slate-700">GDPR準拠</span>
              </div>
              <div className="flex items-center gap-2 bg-white/60 backdrop-blur-sm px-4 py-2 rounded-full border border-slate-200">
                <Scale className="w-4 h-4 text-purple-500" />
                <span className="text-sm font-medium text-slate-700">FTC準拠</span>
              </div>
            </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="font-semibold text-slate-800">法的パッケージ</h3>
                        <p className="text-sm text-slate-500">5つの文書を含む</p>
                      </div>
                    </div>
                  ...
                  <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-4 text-center text-white">
                    <p className="text-sm opacity-90">完全パッケージ</p>
                    <p className="text-3xl font-bold">€79</p>
                    <p className="text-sm opacity-90">一回払い</p>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -top-6 -left-6 bg-white rounded-2xl shadow-xl p-4 transform -rotate-6">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">準拠</p>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -bottom-4 -right-4 bg-white rounded-2xl shadow-xl p-4 transform rotate-6">
                <div className="flex items-center gap-2">
                  <div className="flex -space-x-2">
                    <img src={nicoleProfile} alt="ユーザー" className="w-8 h-8 rounded-full border-2 border-white object-cover" />
