      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-lg font-semibold text-white">Domínios Premium</span>
            </div>
            <p className="text-slate-400 text-sm leading-relaxed mb-4">
              O seu parceiro de confiança para domínios expirados premium com alta autoridade de domínio e backlinks de qualidade.
            </p>
          ...
          <div>
            <h4 className="text-white font-semibold mb-4">Todas as Páginas</h4>
            <ul className="space-y-2">
              <li>
              ...
              <li>
                <Link to="/expireddomainnames/pt/comprar-dominios-premium-alta-autoridade-valor-seo" className="text-slate-400 hover:text-amber-400 transition-colors text-sm">
                  Domínios Premium
                </Link>
              </li>
              <li>
                <Link to="/expireddomainnames/pt/documentos-legais-dominios-premium" className="text-slate-400 hover:text-amber-400 transition-colors text-sm">
                  Documentos Legais
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-slate-500 text-xs">
                Respondemos dentro de 24 horas à sua mensagem.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 border-t border-slate-800 pt-8">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-medium text-white">Domínios Premium</span>
          </div>
          <p className="text-slate-500 text-sm text-center md:text-right">
            © {new Date().getFullYear()} IAEE. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
...
export default FooterPremiumDomainsPT;
