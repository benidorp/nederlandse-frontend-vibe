  ...
  return (
    <>
      <Helmet>
        ...
        <script type="application/ld+json">{`{"@context":"https://schema.org","@graph":[{"@type":"Organization","@id":"https://iaee.eu/#organization","name":"IAEE Premium Domains","url":"https://iaee.eu"},{"@type":"WebPage","url":"${url}","inLanguage":"${c.lang}"},{"@type":"ItemList","name":"${c.brandName}","numberOfItems":${premiumDomains.length},"itemListElement":${JSON.stringify(premiumDomains.slice(0,10).map((d,i)=>({"@type":"ListItem","position":i+1,"item":{"@type":"Product","name":d.name,"sku":d.name,"image":"https://www.iaee.eu/images/premium-domains-og.jpg","description":(d.description||`Premium expired domain ${d.name} with high authority and SEO value.`).slice(0,300),"brand":{"@type":"Brand","name":"IAEE Premium Domains"},"offers":{"@type":"Offer","url":`https://www.iaee.eu/domains/${d.name.replace(/\./g,'-')}`,"price":d.price.replace(/[^0-9]/g,""),"priceCurrency":"EUR","availability":"https://schema.org/InStock","priceValidUntil":`${new Date().getFullYear()+1}-12-31`,"shippingDetails":{"@type":"OfferShippingDetails","shippingRate":{"@type":"MonetaryAmount","value":"0","currency":"EUR"},"shippingDestination":{"@type":"DefinedRegion","addressCountry":["NL","BE","DE","FR","IT","ES","AT","PT","IE","FI","SE","DK","PL","CZ","SK","HU","RO","BG","HR","SI","EE","LV","LT","LU","MT","CY","GR","US","GB"]},"deliveryTime":{"@type":"ShippingDeliveryTime","handlingTime":{"@type":"QuantitativeValue","minValue":0,"maxValue":1,"unitCode":"DAY"},"transitTime":{"@type":"QuantitativeValue","minValue":1,"maxValue":5,"unitCode":"DAY"}}},"hasMerchantReturnPolicy":{"@type":"MerchantReturnPolicy","applicableCountry":["NL","BE","DE","FR","IT","ES","AT","PT","IE","FI","SE","DK","PL","CZ","SK","HU","RO","BG","HR","SI","EE","LV","LT","LU","MT","CY","GR"],"returnPolicyCategory":"https://schema.org/MerchantReturnNotPermitted"}}}})))}}]}`}</script>
      </Helmet>
      <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <LanguageSwitcher currentLanguage={c.lang} />
