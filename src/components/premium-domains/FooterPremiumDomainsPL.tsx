      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-lg font-semibold text-white">Domeny Premium</span>
            </div>
            <p className="text-slate-400 text-sm leading-relaxed mb-4">
              Twój zaufany partner w zakresie wygasłych domen premium z wysokim autorytetem domeny i wysokiej jakości backlinkami.
            </p>
          ...
          <div>
            <h4 className="text-white font-semibold mb-4">Wszystkie Strony</h4>
            <ul className="space-y-2">
              <li>
              ...
              <li>
                <Link to="/expireddomainnames/pl/kup-domeny-premium-wysoki-autorytet-wartosc-seo" className="text-slate-400 hover:text-amber-400 transition-colors text-sm">
                  Domeny Premium
                </Link>
              </li>
              <li>
                <Link to="/expireddomainnames/pl/dokumenty-prawne-domeny-premium" className="text-slate-400 hover:text-amber-400 transition-colors text-sm">
                  Dokumenty Prawne
                </Link>
              </li>
              <li>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 border-t border-slate-800 pt-8">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-medium text-white">Domeny Premium</span>
          </div>
          <p className="text-slate-500 text-sm text-center md:text-right">
            © {new Date().getFullYear()} IAEE. Wszelkie prawa zastrzeżone.
          </p>
        </div>
      </div>
    </footer>
...
export default FooterPremiumDomainsPL;
