      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-4">
              Ihr zuverlässiger Partner für Premium Expired Domains mit hoher Domain Authority und qualitativ hochwertigen Backlinks.
            </p>
          ...
          <div>
            <h4 className="text-white font-semibold mb-4">Alle Seiten</h4>
            <ul className="space-y-2">
              <li>
              ...
              <li>
                <Link to="/expireddomainnames/de/premium-domains-kaufen-hohe-autoritaet-seo-wert" className="text-slate-400 hover:text-amber-400 transition-colors text-sm">
                  Premium Domains
                </Link>
              </li>
              <li>
                <Link to="/expireddomainnames/de/rechtliche-dokumente-premium-domains" className="text-slate-400 hover:text-amber-400 transition-colors text-sm">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 border-t border-slate-800 pt-8">
          ...
          <p className="text-slate-500 text-sm text-center md:text-right">
            © {new Date().getFullYear()} IAEE. Alle Rechte vorbehalten.
          </p>
        </div>
      </div>
    </footer>
...
export default FooterPremiumDomainsDE;