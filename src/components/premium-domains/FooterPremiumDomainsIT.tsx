      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-lg font-semibold text-white">Domini Premium</span>
            </div>
            <p className="text-slate-400 text-sm leading-relaxed mb-4">
              Il vostro partner affidabile per nomi di dominio premium scaduti con alta autorità di dominio e backlink di qualità.
            </p>
          ...
          <div>
            <h4 className="text-white font-semibold mb-4">Tutte le Pagine</h4>
            <ul className="space-y-2">
              <li>
              ...
              <li>
                <Link to="/expireddomainnames/it/acquista-domini-premium-alta-autorita-valore-seo" className="text-slate-400 hover:text-amber-400 transition-colors text-sm">
                  Domini Premium
                </Link>
              </li>
              <li>
                <Link to="/expireddomainnames/it/documenti-legali-domini-premium" className="text-slate-400 hover:text-amber-400 transition-colors text-sm">
                  Documenti Legali
                </Link>
              </li>
              <li>
          ...
          {/* Contact */}
          <div>
            <h4 className="text-white font-semibold mb-4">Contatto</h4>
            <div className="space-y-3">
              ...
              <p className="text-slate-500 text-xs">
                Rispondiamo al vostro messaggio entro 24 ore.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 border-t border-slate-800 pt-8">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-medium text-white">Domini Premium</span>
          </div>
          <p className="text-slate-500 text-sm text-center md:text-right">
            © {new Date().getFullYear()} IAEE. Tutti i diritti riservati.
          </p>
        </div>
      </div>
    </footer>
...
export default FooterPremiumDomainsIT;
