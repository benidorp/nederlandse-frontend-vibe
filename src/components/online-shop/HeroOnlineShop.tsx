      ...
      <div className="container grid lg:grid-cols-2 gap-8 items-center py-12">
        <div className="space-y-6">
          ...
          <p className="text-lg text-primary-foreground/90 leading-relaxed">
            Professional legal documentation crafted specifically for webshops and internet businesses to safeguard your operations and ensure regulatory compliance. 
            Our all-inclusive package covers essential policies including <strong>terms and conditions, GDPR privacy policy, cookie policy, and return procedures</strong>—
            delivering total legal protection, enhanced customer confidence, and peace of mind for your online venture.
          </p>
        ...
        <div className="relative">
          ...
          <img 
            src={heroImage} 
            alt="Professional legal advisor for online businesses" 
