          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="text-left">
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-primary to-primary/60 text-primary-foreground px-6 py-2 rounded-full mb-8 shadow-lg animate-fade-in">
                ...
                <span className="font-semibold">Protection juridique pour les associations</span>
              </div>

              <h1 className="text-4xl font-bold mb-6 bg-gradient-to-r from-primary via-primary/80 to-accent bg-clip-text text-transparent animate-fade-in leading-tight md:text-4xl">
                Documents juridiques essentiels pour les sites web d'associations et d'ONG : Conditions de don, Politique de confidentialité, Accords de bénévolat & Conformité RGPD
              </h1>

              <p className="text-lg md:text-xl text-muted-foreground mb-8 animate-fade-in">
                Protégez votre mission, vos donateurs et vos bénévoles avec des documents juridiques professionnels.
                Conformes au RGPD, prêts pour les dons et utilisés par des associations dans le monde entier.
              </p>

              <div className="grid grid-cols-1 gap-3 mb-10 animate-fade-in">
                {["Conditions de don", "Protection des données des donateurs", "Accords de bénévolat", "100% conforme au RGPD"].map((item, index) => (
              ...
              <div className="flex flex-col gap-4 animate-fade-in">
                <Button size="lg" onClick={() => scrollToSection('pricing')} className="bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-white text-lg px-8 py-6 shadow-xl hover:shadow-2xl transition-all transform hover:scale-105">
                  ...
                  Protégez votre organisation maintenant
                </Button>
              ...
              <p className="mt-8 text-sm text-muted-foreground animate-fade-in">
                ⚡ Téléchargement immédiat • 🔒 Paiement sécurisé • ✅ Garantie satisfait ou remboursé
              </p>
            </div>
            ...
            <div className="relative animate-fade-in">
              <div className="relative">
                ...
                <img src={nicoleWorking} alt="Nicole Henderson - Experte juridique pour associations" className="relative rounded-3xl shadow-2xl w-full h-auto border-4 border-primary/20" />
                <div className="absolute bottom-4 left-4 bg-gradient-to-br from-card/98 via-primary/5 to-card/98 backdrop-blur-md rounded-xl px-5 py-3 border border-primary/40 shadow-2xl hover:shadow-primary/20 hover:scale-105 transition-all duration-300">
                  ...
                  <p className="text-xs font-medium text-muted-foreground">Experte juridique pour associations</p>
                  <p className="text-xs text-muted-foreground/80 mt-1 flex items-center gap-1">
                    <Shield className="w-3 h-3 text-primary" />
                    Protection des associations dans le monde entier
                  </p>
                </div>
              </div>
            </div>
...
export default HeroNonprofitFR;
