      ...
      <div className="container grid lg:grid-cols-2 gap-8 items-center py-12">
        <div className="space-y-6">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-primary-foreground leading-tight">
            الوثائق القانونية لمواقع الأفلييت: الشروط والأحكام، سياسة الخصوصية، الإفصاح وسياسة ملفات تعريف الارتباط
          </h1>
          
          <p className="text-lg text-primary-foreground/90 leading-relaxed">
            وثائق قانونية احترافية تحمي عملك في التسويق بالعمولة وتضمن الامتثال لجميع المتطلبات القانونية.
            تتضمن باقتنا الميسورة جميع الاتفاقيات الأساسية مثل <strong>الشروط والأحكام، سياسة الخصوصية، وإخلاء المسؤولية</strong>—
            للامتثال الكامل والثقة وراحة البال.
          </p>
