        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <Badge variant="outline" className="mb-4 text-lg px-4 py-2">
              Professional Legal Documents for Affiliate Businesses
            </Badge>
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
              All Legally Required Documents Your Affiliate Website Needs
            </h2>
            <p className="text-xl text-muted-foreground leading-relaxed">
              As an affiliate marketer, you earn commissions by recommending products. But did you know that you're 
              <strong> legally required</strong> to have certain legal documents on your website? 
            ...
            <div id="about-me" className="mt-10 p-8 bg-secondary/30 rounded-xl border border-border shadow-sm text-foreground">
              ...
              <div className="space-y-4 text-left max-w-3xl mx-auto">
                ...
                <div className="pt-4">
                  ...
                  <p className="text-base text-muted-foreground leading-relaxed">
                    To answer the many questions about legal requirements for affiliates, I've developed high-quality legal documents specifically for affiliate websites. These documents are designed for both national and international use and provide essential protection at a fraction of the usual cost. Get professional legal coverage at an affordable price—secure your business today!
                  </p>
                </div>
              </div>
            </div>
          ...
          <Card className="mb-8 border-2 border-primary/20 bg-primary/5">
            ...
            <CardContent className="space-y-4">
              <p className="text-lg text-muted-foreground">
                Our complete package contains <strong>all legal documents specifically written for affiliate websites</strong>. 
                Not generic templates, but professional texts that perfectly align with your affiliate business model:
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-4 mt-6">
                <div className="flex items-start gap-3 p-4 rounded-lg bg-secondary/30 border border-primary/10">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Fully compliant with European legislation, including cookie usage and data protection</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-secondary/30 border border-primary/10">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Transparent notification that you earn commissions, compliant with FTC and EU regulations</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-background border border-navy/20">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-foreground/80">Protects you from liability claims and regulates the relationship with visitors</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-background border border-navy/20">
                  <CheckCircle className="h-5 w-5 text-red-600 mt-0.5 flex-shrink-0" />
                  <div>
                    <h4 className="font-semibold mb-1 text-foreground">Legal Disclaimer</h4>
                    <p className="text-sm text-foreground/80">Limits your liability for the recommendations you make</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-background border border-navy/20">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-foreground/80">GDPR compliant, explanation of tracking and analytics cookies</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-background border border-navy/20">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-foreground/80">Step-by-step instructions to place everything correctly on your website</p>
                  </div>
                </div>
              </div>
            </CardContent>
            ...
            <Card className="border-primary/20 bg-primary/5 text-foreground">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-muted-foreground">
                  One purchase, unlimited use. Use these documents for all your current and future affiliate websites!
                </p>
              </CardContent>
            </Card>
