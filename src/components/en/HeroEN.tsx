    ...
    <section id="home" className="relative min-h-[600px] flex items-center bg-primary text-primary-foreground">
      <div className="container grid lg:grid-cols-2 gap-8 items-center py-12">
        <div className="space-y-6">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-primary-foreground leading-tight">Essential Legal Documents for Affiliate Websites: Terms & Conditions, Privacy Policy, Disclosure & Cookie Policy

          </h1>
          
          <p className="text-lg text-primary-foreground/90 leading-relaxed">
            Professional legal documents that protect your affiliate business and ensure compliance with all legal requirements. 
            Our affordable package includes all essential agreements such as <strong>terms and conditions, privacy policy, and disclaimers</strong>—
            for complete compliance, trust, and peace of mind.
          </p>
