      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">Everything you need to know about protecting your non-profit organization website.</p>
          </div>

          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => <AccordionItem key={index} value={`item-${index}`} className="border-2 border-primary/20 rounded-lg px-6 hover:border-primary/40 transition-all">
            ...
            <AccordionItem value="all-nonprofit-questions" className="border-2 border-primary/20 rounded-lg px-6 bg-card shadow-md">
              ...
              <AccordionContent className="text-muted-foreground pb-6">
                <div className="space-y-8 whitespace-pre-line">
                  {[...startingQuestions, ...ownersQuestions].map((item, index) => <article key={index} className="space-y-2">
            ...
            <AccordionItem value="security-questions" className="border-2 border-primary/20 rounded-lg px-6 bg-card shadow-md">
              ...
              <AccordionContent className="text-muted-foreground pb-6">
                <div className="space-y-8 whitespace-pre-line">
                  {securityQuestions.map((item, index) => <article key={index} className="space-y-2">
