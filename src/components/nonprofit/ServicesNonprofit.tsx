...
const ServicesNonprofit = () => {
  const services = [{
    ...
    features: ["One-time & recurring donations", "Tax deductibility information", "Refund and cancellation terms", "Major gift agreements"]
  }, {
    icon: Shield,
    ...
    features: ["Donor data protection", "Volunteer information handling", "Beneficiary privacy", "Email marketing compliance"]
  }, {
    icon: Users,
    ...
    features: ["Role and responsibilities", "Liability protection", "Confidentiality clauses", "Termination procedures"]
  }, {
    icon: Heart,
    ...
    features: ["Fund allocation transparency", "Administrative cost disclosure", "Impact reporting", "Third-party fundraiser terms"]
  }, {
    icon: Scale,
    title: "Cookie Policy",
    ...
    features: ["Cookie categorization", "Consent management", "Analytics tracking", "Third-party cookies"]
  }, {
    icon: CheckCircle,
    ...
    features: ["Document placement guide", "Donation platform integration", "Update procedures", "Compliance checklist"]
  }];
  return <section id="services" className="py-20 bg-gradient-to-b from-background to-primary/5">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Everything Your Non-Profit Website Needs</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => <Card key={index} className="border-2 border-primary/20 hover:border-primary/40 transition-all shadow-lg hover:shadow-xl transform hover:scale-105">
                <CardHeader>
                ...
                <CardContent>
                  ...
                  <ul className="space-y-2">
                    {service.features.map((feature, idx) => <li key={idx} className="flex items-start gap-2 text-sm">
