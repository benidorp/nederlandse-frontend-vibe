      ...
      <div className="container">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Complete package with all legal documents you need for your photography business. Download the package easily in your own language – or in multiple languages – and make your photography website ready for international use.
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          <Card className="border-primary shadow-xl">
            <CardHeader className="text-center pb-8">
              ...
              <CardTitle className="text-2xl">Complete Photography Legal Package</CardTitle>
