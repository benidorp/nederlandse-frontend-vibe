...
const services = [
  {
    ...
    details: [
      ...
      "Copyright and portrait rights protection",
  ...
  },
  {
    ...
    details: [
      "Ready-to-use template document",
      "Sample agreement included",
      "Copy-paste email message templates",
      "Customizable for your services"
    ]
  },
  {
    icon: Shield,
    ...
    details: [
      ...
      "Photography-specific privacy terms",
      "Mandatory for website contact forms"
    ]
  },
  {
    icon: Cookie,
  ...
  },
  {
    ...
    details: [
      "Pre-shoot legal coverage",
      "Clear agreements with subjects",
      "Model release provisions",
      "Portrait rights protection"
    ]
  },
  {
    icon: BookOpen,
      ...
      <div className="container">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            For a professional photography business, the following legal documents are essential. 
            Our package contains everything you need to protect your work and business.
          </p>
        </div>
