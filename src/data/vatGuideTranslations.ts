...
const guideES: VATGuideContent = {
  ...
  sections: {
    ...createGuideTranslation("es", "", "", "", "IVA").sections,
    ...
    s2FormulaTip: "Consejo: Usa nuestra calculadora para realizar estos cálculos automáticamente para cualquier país.",
    ...
    s8Title: "IVA e impuestos sobre ventas en el mundo",
...
// ITALIAN (IT)
// ═══════════════════════════════════════════
const guideIT: VATGuideContent = {
  badge: "Guida Completa IVA 2025-2026",
  title: "La Guida Definitiva al Calcolo dell'IVA Internazionale",
  subtitle: "Tutto ciò che devi sapere sul calcolo dell'IVA per e-commerce, freelancer, aziende SaaS e commercio internazionale — attuale, affidabile e basato su anni di esperienza pratica.",
  sections: {
    ...createGuideTranslation("it", "", "", "", "IVA").sections,
    s1Title: "Cos'è l'IVA e perché è essenziale calcolarla correttamente?",
    s2Title: "Come funziona il sistema IVA nel mondo?",
    s2FormulaTitle: "Calcolo dell'IVA: le formule base",
    s2FormulaAdd: "Aggiungere IVA (imponibile → totale):",
    s2FormulaAddDesc: "Importo IVA inclusa = Importo IVA esclusa × (1 + Percentuale IVA / 100)",
    s2FormulaRemove: "Scorporare IVA (totale → imponibile):",
    s2FormulaRemoveDesc: "Importo IVA esclusa = Importo IVA inclusa ÷ (1 + Percentuale IVA / 100)",
    s2FormulaTip: "Suggerimento: Usa il nostro calcolatore per eseguire questi calcoli automaticamente per qualsiasi paese.",
    s3Title: "Calcolare l'IVA per e-commerce, negozi online e vendite online",
    s4Title: "Calcolare l'IVA per freelancer e lavoratori autonomi",
    s5Title: "Calcolare l'IVA per SaaS, software e abbonamenti digitali",
    s6Title: "IVA all'importazione ed esportazione: cosa devi sapere",
    s7Title: "Normativa IVA UE e il One Stop Shop (OSS)",
    s8Title: "IVA e imposte sulle vendite nel mondo",
    s9Title: "Conformità IVA: best practice per 2025-2026",
    s9InvoiceTitle: "Fatturazione e amministrazione",
    s9DeadlineTitle: "Scadenze e dichiarazioni",
    s10Title: "Per cosa puoi usare il nostro calcolatore IVA?",
    s11Title: "Perché scegliere questo calcolatore IVA internazionale?"
  }
};
...
const guidePT: VATGuideContent = {
  ...
  sections: {
    ...createGuideTranslation("pt", "", "", "", "IVA").sections,
    ...
    s8Title: "IVA e impostos sobre vendas no mundo",
    s9Title: "Conformidade com IVA: melhores práticas para 2025-2026",
...
const guidePL: VATGuideContent = {
  ...
  sections: {
    ...createGuideTranslation("pl", "", "", "", "VAT").sections,
    ...
    s8Title: "VAT i podatki od sprzedaży na świecie",
...
export const vatGuideTranslations: Record<string, VATGuideContent> = {
  ...
  pt: guidePT,
  pl: guidePL,
  // For remaining languages, use English with localized VAT term
  tr: createGuideTranslation("tr", "Kapsamlı KDV Rehberi 2025-2026", "Uluslararası KDV Hesaplama Rehberi", "KDV hesaplama hakkında bilmeniz gereken her şey.", "KDV"),
  ...
  sv: createGuideTranslation("sv", "Moms Guide 2025-2026", "Den Ultimata Guiden till Internationell Momsberäkning", "Allt du behöver veta om momsberäkning.", "moms"),
  no: createGuideTranslation("no", "MVA Guide 2025-2026", "Den Ultimate Guiden til Internasjonal MVA-Beregning", "Alt du trenger å vite om MVA-beregning.", "MVA"),
  da: createGuideTranslation("da", "Moms Guide 2025-2026", "Den Ultimative Guide til International Momsberegning", "Alt du behøver at vide om momsberegning.", "moms"),
  fi: createGuideTranslation("fi", "ALV-opas 2025-2026", "Täydellinen Opas Kansainväliseen ALV-Laskentaan", "Kaikki mitä sinun tarvitsee tietää ALV-laskennasta.", "ALV"),
  cs: createGuideTranslation("cs", "Průvodce DPH 2025-2026", "Kompletní Průvodce Mezinárodním Výpočtem DPH", "Vše, co potřebujete vědět o výpočtu DPH.", "DPH"),
  ...
  ru: createGuideTranslation("ru", "Руководство по НДС 2025-2026", "Полное Руководство по Расчёту Международного НДС", "Всё, что вам нужно знать о расчёте НДС.", "НДС"),
  ro: createGuideTranslation("ro", "Ghid TVA 2025-2026", "Ghidul Complet pentru Calculul TVA Internațional", "Tot ce trebuie să știți despre calculul TVA.", "TVA"),
  bg: createGuideTranslation("bg", "Ръководство за ДДС 2025-2026", "Пълно Ръководство за Международно Изчисляване на ДДС", "Всичко, което трябва да знаете за изчисляването на ДДС.", "ДДС"),
  uk: createGuideTranslation("uk", "Посібник з ПДВ 2025-2026", "Повний Посібник з Міжнародного Розрахунку ПДВ", "Все, що вам потрібно знати про розрахунок ПДВ.", "ПДВ"),
  hr: createGuideTranslation("hr", "Vodič za PDV 2025-2026", "Potpuni Vodič za Međunarodni Izračun PDV-a", "Sve što trebate znati o izračunu PDV-a.", "PDV"),
  sk: createGuideTranslation("sk", "Sprievodca DPH 2025-2026", "Kompletný Sprievodca Medzinárodným Výpočtom DPH", "Všetko, čo potrebujete vedieť o výpočte DPH.", "DPH"),
  sr: createGuideTranslation("sr", "Водич за ПДВ 2025-2026", "Комплетан Водич за Међународни Обрачун ПДВ-а", "Све што треба да знате о обрачуну ПДВ-а.", "ПДВ"),
  sl: createGuideTranslation("sl", "Vodnik za DDV 2025-2026", "Popoln Vodnik za Mednarodni Izračun DDV", "Vse, kar morate vedeti o izračunu DDV.", "DDV"),
  ko: createGuideTranslation("ko", "부가가치세 가이드 2025-2026", "국제 부가가치세 계산 완전 가이드", "부가가치세 계산에 대해 알아야 할 모든 것.", "VAT"),
  hu: createGuideTranslation("hu", "ÁFA Útmutató 2025-2026", "Teljes Útmutató a Nemzetközi ÁFA Számításhoz", "Minden, amit az ÁFA számításról tudni kell.", "ÁFA"),
  ...
  is: createGuideTranslation("is", "VSK Leiðbeiningar 2025-2026", "Ítarleg Leiðbeiningar um Alþjóðlegan VSK Útreikning", "Allt sem þú þarft að vita um VSK útreikning.", "VSK"),
  ...
  mk: createGuideTranslation("mk", "Водич за ДДВ 2025-2026", "Комплетен Водич за Меѓународна Пресметка на ДДВ", "Сè што треба да знаете за пресметка на ДДВ.", "ДДВ"),
  bs: createGuideTranslation("bs", "Vodič za PDV 2025-2026", "Potpuni Vodič za Međunarodni Obračun PDV-a", "Sve što trebate znati o obračunu PDV-a.", "PDV"),
