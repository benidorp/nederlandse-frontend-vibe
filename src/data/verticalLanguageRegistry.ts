...
export const verticalLanguages: Record<VerticalId, VerticalLanguageEntry[]> = {
  ...
  "premium-domains": [
    ...
    { code: "ko", name: "한국어", path: "/expireddomainnames/ko/peurimieom-domein-gumaehagi-nopun-gwonwi-seo-gachi" },
    { code: "hu", name: "Magyar", path: "/expireddomainnames/hu/premium-domain-vasarlas-magas-tekintely-seo-ertek" },
    { code: "th", name: "ไทย", path: "/expireddomainnames/th/sue-domain-premium-amnaj-sung-kha-seo" },
    { code: "vi", name: "Tiếng Việt", path: "/expireddomainnames/vi/mua-ten-mien-premium-uy-tin-cao-gia-tri-seo" },
    { code: "id", name: "Bahasa Indonesia", path: "/expireddomainnames/id/beli-domain-premium-otoritas-tinggi-nilai-seo" },
    { code: "et", name: "Eesti", path: "/expireddomainnames/et/osta-premium-domeenid-korge-autoriteet-seo-vaartus" },
    { code: "lv", name: "Latviešu", path: "/expireddomainnames/lv/pirkt-premium-domenu-augsta-autoritaate-seo-vertiba" },
    { code: "lt", name: "Lietuvių", path: "/expireddomainnames/lt/pirkti-premium-domenus-auksta-autoritetas-seo-verte" },
    { code: "is", name: "Íslenska", path: "/expireddomainnames/is/kaupa-premium-len-hatt-vald-seo-virdi" },
    { code: "sq", name: "Shqip", path: "/expireddomainnames/sq/blini-domain-premium-autoritet-larte-vlere-seo" },
    { code: "mk", name: "Македонски", path: "/expireddomainnames/mk/kupete-premium-domeni-visok-avtoritet-seo-vrednost" },
    { code: "bs", name: "Bosanski", path: "/expireddomainnames/bs/kupite-premium-domene-visoki-autoritet-seo-vrijednost" },
    { code: "lb", name: "Lëtzebuergesch", path: "/expireddomainnames/lb/kaaft-premium-domainen-hech-autoritaet-seo-wert" },
    { code: "bn", name: "বাংলা", path: "/expireddomainnames/bn/premium-domain-kinun-uccho-kartritwa-seo-mulya" },
    { code: "ms", name: "Bahasa Melayu", path: "/expireddomainnames/ms/beli-domain-premium-autoriti-tinggi-nilai-seo" },
  ],
